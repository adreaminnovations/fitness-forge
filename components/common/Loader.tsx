        ...
        <section className="bg-slate-800/50 py-20 sm:py-28">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="h-80 md:h-96 bg-slate-700 rounded-2xl border border-slate-600 flex items-center justify-center">
                       <span className="text-slate-500">Gym interior image</span>
                    </div>
                </div>
            </div>
        </section>
